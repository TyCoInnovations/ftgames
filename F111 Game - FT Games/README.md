...
<body>
  ...
  <div id="loading" class="screen">
    ...
    <h1 class="loading-text">FT Games</h1>
  ...
  <script>
    ...
    try {
      ...
      try {
        scaffolding.addCloudProvider(new Scaffolding.Cloud.WebSocketProvider(["wss://clouddata.turbowarp.org","wss://clouddata.turbowarp.xyz"], "p4-@f111 game (WIP) (FOR 60FPS)_.sb3"));
      } catch (error) {
        console.error(error);
      }
